package ru.otus.message_server.runner;

import ru.otus.message_server.app.ProcessRunner;
...
public class ProcessRunnerImpl implements ProcessRunner {
    ...
    private Process runProess(String command) throws IOException {
